  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'steps', title: 'Bạn có thể làm gì', items: [
        ...
        '**Chọn cột:** nút **Cột** bật thêm **Doanh thu** (giá trị chuyển đổi của loại kết quả bạn chọn ở Cài đặt → Chung, ví dụ tổng giá trị đơn hàng; để “–” hoặc 0 nếu chiến dịch không có giá trị), Lượt hiển thị, Lượt nhấp, CTR, CPC, CPM (mặc định 5 cột). Lựa chọn được nhớ. Nhiều cột thì bảng cuộn ngang, hai cột đầu, dòng tiêu đề và **hàng Tổng** ở đáy luôn cố định.',
