  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'steps', title: 'Bạn có thể làm gì', items: [
        ...
        '**Chọn cột:** nút **Cột** bật thêm Lượt hiển thị, Lượt nhấp, CTR, CPC, CPM (mặc định 5 cột). Lựa chọn được nhớ. Nhiều cột thì bảng cuộn ngang, hai cột đầu, dòng tiêu đề và **hàng Tổng** ở đáy luôn cố định.',
        ...
        '**Hành động hàng loạt:** menu **Hành động** gồm Đổi ngân sách hàng loạt, Bật và Tắt các mục **đang hiển thị** sau khi lọc (có ghi rõ số mục sẽ bị đổi), và luôn hỏi xác nhận trước.',
