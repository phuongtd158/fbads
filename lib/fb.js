...
const EMPTY = { spend: 0, impressions: 0, clicks: 0, results: 0, revenue: 0, conversations: 0, checkouts: 0, leads: 0, leadsOnMeta: 0, comments: 0, cpa: null, roas: null };
...
function mockRange(days) {
  ...
  return Object.fromEntries(mockObjs.map((o) => {
    ...
    return [o.id, { spend, impressions: spend * 9, clicks: Math.round(spend / 900), results, revenue: results * 380000, cpa: results ? spend / results : null, roas: spend ? (results * 380000) / spend : null, ...mockExtras(spend, o.seed) }];
  }));
}
