    ...
    for (const id of accountIds()) {
      try {
        const [ic, ia] = await Promise.all([
          graphAll(`${actOf(id)}/insights`, { level: 'campaign', date_preset: range, fields: 'campaign_id,spend,impressions,clicks,actions,action_values' }),
          graphAll(`${actOf(id)}/insights`, { level: 'adset', date_preset: range, fields: 'adset_id,spend,impressions,clicks,actions,action_values' }),
        ]);
