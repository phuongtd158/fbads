...
const fails = new Map();
// Sau proxy (ngrok, Fly.io…): ưu tiên fly-client-ip; nếu không thì lấy phần tử CUỐI của X-Forwarded-For (do proxy gần nhất thêm vào,
// khác phần tử đầu là chỗ người dùng có thể tự điền giả để lách giới hạn nhập sai mật khẩu).
function ipOf(req) {
